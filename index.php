...
<body>
       <div class="container">
                     ...
                     <div class="col-md-3 mb-2 mb-md-0">
                            <a href="/"
                               class="d-inline-flex link-body-emphasis text-decoration-none">
                                   <img width="90"
                                        src="assets/images/logo-bookeo.jpg"
                                        alt="Logo Bookeo">
                            </a>
                     </div>
              ...
              <div class="row flex-lg-row-reverse align-items-center justify-content-center g-5 py-5">
                     ...
                     <div class="col-lg-6">
                            <h1 class="display-5 fw-bold lh-1 text-center mb-3">Responsive left-aligned hero with
                                   image
                            </h1>
              ...
              <!-- Fin Heroes Bootstrap -->
              <div class="row text-center">
                     <!-- Card Bootstrap-->
                     <div class="col-md-4 my-2 d-flex">
                            <div class="card">
                                   <img src="
                                 uploads/books/1-1984.jpg"
                                        class="card-img-top"
                                        alt="...">
                                   <div class="card-body">
                     ...
                     <div class="col-md-4 my-2 d-flex">
                            <div class="card">
                                   <img src="
                                 uploads/books/2-histoires-courtes.jpg"
                                        class="card-img-top"
                                        alt="...">
                                   <div class="card-body">
                                          <h5 class="card-title">Card title</h5>
                     ...
                     <div class="col-md-4 my-2 d-flex">
                            <div class="card">
                                   <img src="
                                 uploads/books/3-zai-zai-zai-zai.jpg"
                                        class="card-img-top"
                                        alt="...">
                                   <div class="card-body">
                                          <h5 class="card-title">Card title</h5>
